...
【重要提醒：不要使用必应搜索下载图吧工具箱，能搜到的全是假的，真官网于2025年4月左右被完全屏蔽！！！】
【重要提醒：不要使用必应搜索下载图吧工具箱，能搜到的全是假的，真官网于2025年4月左右被完全屏蔽！！！】
【重要提醒：不要使用必应搜索下载图吧工具箱，能搜到的全是假的，真官网于2025年4月左右被完全屏蔽！！！】
【图吧工具箱官网：	https://www.tbtool.cn】
【备用官网：	https://tbtool.dawnstd.cn】
【建议收藏这两个网站便于后续使用，或直接通过工具箱其他工具里边的检查更新工具直达官网】
【团队并未授权任何镜像站、分流站，也不会提供夸克网盘、迅雷网盘下载链接，看到这两个网盘默认假即可！】
【作者已多次向必应反馈网站被屏蔽、假官网、银狐木马的问题，但截至2026/7/16必应方面并没有解决】

1.TM5、Core Temp、CPUZ、GPUZ、Furmark2、Everything、Rufus、Ventoy、DDU、DXVAChecker、nvidiaProfileInspector、WizTree、AIDA64、HWiNFO、HWMonitor、SpaceSniffer更新到最新版本。

2.暂时移除ThrottleStop(保留图标，其提权驱动包含漏洞，等它更新后会重新加入)，重新加入ZenTimings。

目前作者正在全力准备C++版，在AI的帮助下已完成绝大部分工作(UI已完成90%+，硬件检测已完成，数据库部分已完成)，奈何工作繁忙，并没有太多时间，预计要2027年初才能发布。

C++版无法完全复刻当前版本功能，但相对也加入了部分当前版本没有的功能，比如砍了UI的GPU加速，加入了自定义分类。

官网下载页已提供绿色版的下载链接，为了防止“为什么解压要钱？、压缩文件损坏上传不检查吗？、为什么加病毒”之类重复且低质问题藏得比较“深”，各位需要的仔细找找即可。另外统一回复，为什么只提供123网盘链接，这是目前作者找到的唯一能免费不限速下载且不需要客户端的网盘，仅此而已。

免费软件能维持更新维护12年实属不易，团队已拒绝几乎所有的商业合作，仅保留少量不影响使用的广告用于覆盖运营成本，望理解！如果不想看到广告，可以在官网下载页下载工具管理器自行删除，忘各位大神懂哥嘴下留情！

考虑国内软件行业、搜索行业现状及团队成员面临的生存压力，作者无法保证下一个十年能否持续更新、维护，言尽于此，且用且珍惜。

===================================================================================

2026.01.1更新内容如下：

暂时移除因提权驱动不稳定影响正常使用的zentimings，待其驱动稳定后再加回。没有其他修改。

===================================================================================

图吧工具箱2026.01更新内容如下：

新增工具外设测试中心，支持在线测试键盘、鼠标、音响、显示器。

Geek Uninstaller、ventoy、DDU、DXVAChecker、AIDA64、HWMonitor、HWiNFO、tm5更新到0.13.1(0.13版本被windows defender误报所以一直没更新)更新到最新版本。

检查更新页面重做，更直观了。

删除流量卡领卡渠道广告，似乎很多人认为这个是诈骗，原因是一个口述的“收到的卡与描述不符、售后联系不上”的视频？实际领卡渠道具备工信部颁发的增值电信业务经营许可证，在我的认知里，诈骗网站或企业是无法办理的。希望大家能保持独立思考与判断的能力，在没有证据或没有定性之前理性看待问题，不要被带节奏、当枪使。
同时为了避免类似情况及争议发生，新版将会删掉办理渠道入口。为保障已经领卡用户的权益(如续约)，仍会保留售后入口。

近期留意到似乎有很多用户希望能下载旧版，为响应这部分需求，官网下载页已放出旧版合集网盘链接，可以按需下载或转存。但同时也必须提醒下：旧版可能存在windows defender拦截、工具无法检测最新硬件或检测到错误的结果、工具失效(特指不能说的工具)、不支持高DPI屏幕等等一系列问题。所谓工具缺失，实际只有chipgenius(已停更，常搭配flashmaster使用用于检测U盘主控及颗粒，因windows defender误报删除)，wtg辅助工具(win to go辅助安装工具，因windows defender误报删除)。

另外回应下关于广告的问题：原捐赠渠道无法维持现有规模故已关闭，广告是目前图吧工具箱收回运营成本的唯一方式。加入的广告不会出现主动弹窗、自启或任何类似的影响使用体验的行为，且所有的广告均可通过官网下载页的“工具管理器”手动删除(不建议，所有人都删除意味着运营成本无法收回)。

===================================================================================

图吧工具箱2025.12更新内容如下(寄了，windows defender smartscreen拦截)：

GPUZ、AIDA64、Furmark2、Rufus、Ventoy、HWMonitor、CDI、CDM、CPUZ、
DDU、显卡天梯图、CPU天梯图、HWiNFO更新到最新版本。

新增“核间延迟测试”、CDM原版(相比皮肤版多了个读写混合测试)。

===================================================================================

图吧工具箱2025.07.2更新内容如下：

GPUZ更新到最新版、显卡天梯图更新到最新版。
